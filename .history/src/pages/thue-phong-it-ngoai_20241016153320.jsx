	...
	return (
		<>
			<Head>
				...
				<meta
					property="og:url"
					content="https://nphdigital.com/thue-phong-it-ngoai"
				/>
				<meta
					property="og:image"
				...
				<link
					rel="canonical"
					href="https://nphdigital.com/thue-phong-it-ngoai"
				/>
				...
				<script
					...
					dangerouslySetInnerHTML={{
						__html: JSON.stringify({
							...
							sameAs: ['https://www.facebook.com/NPHDigital', 'https://twitter.com/NPHDigital'],
						}),
					}}
				/>
			</Head>
