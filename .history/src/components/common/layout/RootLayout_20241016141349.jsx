		...
		<CommonAnimation>
			...
			<style jsx>{`
				.particles-container {
					...
					z-index: 1; /* Đặt chỉ số z âm để nằm dưới tất cả các phần tử khác */
					pointer-events: none; /* Ngăn chặn mọi sự kiện chuột tương tác với particles */
				}
			`}</style>
		</CommonAnimation>
	);
