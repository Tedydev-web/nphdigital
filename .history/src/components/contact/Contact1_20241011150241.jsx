...
const Contact1 = () => {
	...
	const sendEmail = (e) => {
		...
		const serviceID = 'nphdigitalcom'; // Replace with your actual service ID
		const templateID = 'nphdigitalcom'; // Replace with your actual template ID
		const userID = 'fvan4FMFu4HeemPfC'; // Replace with your actual user ID
