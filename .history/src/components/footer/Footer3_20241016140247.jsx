...
import ParticlesComponent from './ParticlesComponent'; // Import your new ParticlesComponent
...
export default function Footer3() {
    ...
    return (
        <footer className="footer__area" style={{ position: 'relative', overflow: 'hidden' }}>
            <ParticlesComponent /> {/* Use your ParticlesComponent here */}
            <div className="footer__top-2 text-anim" style={{ position: 'relative', zIndex: 1 }}>
